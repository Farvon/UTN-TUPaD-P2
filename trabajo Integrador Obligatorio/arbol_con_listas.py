...
def crear_arbol(arbol):
    ...
    if not arbol:
        arbol = [int(input("Ingrese el nodo raiz del arbol: ")),[],[]]
        return arbol
    else:
        return False  
    ...
    if arbol[0]:
        ...
        if nodo < arbol[0]:
            if arbol[1]:
                ...
                print(f"El valor {nodo} NO se encuentra en el arbol")
        if nodo > arbol[0]:
            if arbol[2]:
...
#LLama a los diferentes métodos para recorrer el arbol
...
while salir != 0:
    ...
    print("-"*30)
    print("1 - Crear arbol")
    print("2 - Visualizar Arbol")
    print("3 - Agregar Nodo")
    print("4 - Buscar valor en Arbol")
    print("5 - Recorrer Arbol ( InOrder / PreOrder / PostOrder )")
    print("0 - Salir")
    print("-"*30)
    ...
    match opcion:
        ...
        case 2:
            ...
            if arbol:
                ...
                print("El arbol aun no existe. Favor de crearlo..")
            input("Precione enter para volver...")
        case 3:
            os.system('cls')
            if arbol:
